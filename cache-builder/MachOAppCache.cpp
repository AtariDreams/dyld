...
void MachOAppCache::forEachPrelinkInfoLibrary(Diagnostics& diags,
    ...
    for (CFIndex i = 0; i != CFArrayGetCount(prelinkInfoDictionaryArrayRef); ++i) {
        ...
        if (bundleLibrariesDictionaryRef != nullptr) {
            ...
            CFDictionaryApplierFunction applyCallback = [](const void *key, const void *value, void *context) {
            ...
            CFDictionaryApplyFunction(bundleLibrariesDictionaryRef, applyCallback, &applyContext);
